...
describe('fileUtils', () => {
    ...
    describe('doesPathExist', () => {
        ...
        it('should return false if path does not exist', async () => {
            ...
            expect(mockApp.vault.adapter.exists).toHaveBeenCalledWith('nonexistent/path');
        });
    ...
    describe('createFolder', () => {
        ...
        it('should throw error if folder creation fails', async () => {
            ...
            await expect(
                createFolder(mockApp as any, 'new/folder')
            ).rejects.toThrow('Failed to create folder at new/folder: Permission denied');
        });
    });
    ...
    describe('createFolderStructure', () => {
        ...
        it('should return true if folder already exists', async () => {
            ...
            const result = await createFolderStructure(mockApp as any, 'existing/folder');
